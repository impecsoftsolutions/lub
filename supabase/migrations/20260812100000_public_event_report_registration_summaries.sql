-- Add fresh, allowlist-scoped Gender and Meal Preference summaries to every
-- successful public report rows response. The function signature stays intact.
      ...
      COALESCE(
        (
          SELECT jsonb_agg(
            ...
            ORDER BY counts.response_count DESC, counts.normalized_value ASC NULLS LAST
          )
