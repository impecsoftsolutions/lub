...
BEGIN
  ...
  SET
    ...
    gst_certificate_url = NULLIF(p_data->>'gst_certificate_url', ''),
    ...
    udyam_certificate_url = NULLIF(p_data->>'udyam_certificate_url', ''),
    ...
    payment_proof_url = NULLIF(p_data->>'payment_proof_url', ''),
...
IS 'Updates member profile for custom-auth users, including registration document URL fields, and always resubmits status to pending review.';
