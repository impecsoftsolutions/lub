/*
  COD-EVENTS-RSVP-CAPACITY-VISIBILITY-082

  Adds per-event public visibility toggle for registration capacity stats.
  Source of truth is `events.ai_metadata.rsvp_hide_capacity_publicly`.

  Semantics:
  - true  => hide capacity/filled numbers on public registration block
  - false => show capacity/filled numbers (default)
*/
