-- COD-EVENTS-REGISTRATION-DUPLICATE-GUARD-076
-- Hotfix badge-code return query to match deployed event_badges schema. Also returns issued badge code after public registration so the website can show
