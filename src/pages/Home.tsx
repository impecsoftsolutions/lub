      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="text-center space-y-6 sm:space-y-8">
            ...
            <p className="text-lg leading-8 sm:text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              {!isAuthenticated && (
                <Link
                  to="/signup"
                  className="w-full sm:w-auto bg-orange-500 hover:bg-orange-600 text-white px-6 sm:px-8 py-3 rounded-lg font-semibold text-base sm:text-lg transition-colors duration-200 flex items-center justify-center"
                >
                  Member Registration
              ...
              <Link
                to="/events"
                className="w-full sm:w-auto border-2 border-white text-white hover:bg-white hover:text-blue-900 px-6 sm:px-8 py-3 rounded-lg font-semibold text-base sm:text-lg text-center transition-colors duration-200"
              >
                Explore Activities
              </Link>
            </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="text-center group rounded-lg border border-border sm:border-transparent p-4 sm:p-0">
