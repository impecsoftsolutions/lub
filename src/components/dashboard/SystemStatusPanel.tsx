      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
            ...
            <span className="text-lg font-semibold text-primary">{systemStatus.activeStates}</span>
          </div>
          ...
          <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
            ...
            <span className="text-lg font-semibold text-primary">{systemStatus.totalDesignations}</span>
          </div>
          ...
          <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
            ...
            <span className="text-lg font-semibold text-primary">{systemStatus.formFieldsConfigured}</span>
          </div>
